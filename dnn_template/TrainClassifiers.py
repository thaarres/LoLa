...
# Reading H5FS
infname_train = "/scratch/snx3000/gregork/train-img-min-5deg-v8.h5"
infname_test  = "/scratch/snx3000/gregork/test-img-min-5deg-v8.h5"
...
#               ),
    ...
    Classifier("NNXd_min_5deg_sample_v8_v31_" + SUFFIX, 
               "keras",
               params,
               False,
               datagen_train_pixel,
